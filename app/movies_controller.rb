...
def can_be_found_updated_and_saved
  ...
  __update_move = Movie.find_by(title: "Awesome Flick")
  __update_move.update(title: "Even Awesomer Flick")
  __update_move
end
...
def can_update_using_update_method
  ...
  update_move = Movie.find_by(title: "Wat?").update(title: "Wat, huh?")
